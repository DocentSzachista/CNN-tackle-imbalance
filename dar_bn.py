"""It is a code from: https://arxiv.org/pdf/2112.08810v2.pdf#appendix.E
    All the rights to this code belong to the respective owners.
"""
import torch
...
def oversampling_with_pure_noise_train_epoch(model, balanced_loader, criterion,
optimizer, delta, num_samples_per_class, dataset_mean, dataset_std, image_size):
